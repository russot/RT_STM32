...
class Serial_writer(threading.Thread):
	...
	def run(self):
		...
		time.sleep(0.1)
		while True:
			self.serial.write("adc:pga:R:0x55")
			time.sleep(0.1)
			self.serial.write("adc:pga:A:0x55")
			time.sleep(0.1)
			print "0x55 "
			os.system("pause")
			self.serial.write("adc:pga:R:15")
			time.sleep(0.1)
			self.serial.write("adc:pga:A:15")
			time.sleep(0.1)
			self.serial.write("adc:pga:B:15")
			time.sleep(0.1)
			self.serial.write("adc:pga:S:15")
			time.sleep(0.1)
			print "15 "
			os.system("pause")
			...
			time.sleep(0.1)
			self.serial.write("adc:pga:S:240")
			time.sleep(0.1)
			print "240"
			os.system("pause")
			break
			#self.serial.write("adc:pga:A:170")
			#self.serial.write("adc:pga:A:85")
		#	for i in range(0,30):
		#		self.serial.write("vout:dec:10")
		#		time.sleep(0.3)
		#	for i in range(0,30):
		#		self.serial.write("vout:inc:10")
		#		time.sleep(0.3)
