...
class Serial_writer(threading.Thread):
	...
	def run(self):
		...
		count =0
		while True:
			self.serial.write("adc:swt:R:Y")
			time.sleep(1)
			self.serial.write("adc:swt:NTC:Y")
			time.sleep(1)
			self.serial.write("adc:swt:A:A1")
			time.sleep(2.5)
			self.serial.write("adc:swt:R:N")
			time.sleep(1)
			self.serial.write("adc:swt:NTC:N")
			time.sleep(1)
			self.serial.write("adc:swt:A:A2")
			time.sleep(2.5)
